...
const LOCATIONS = [
...

  {
    ...
    rewards: { coins: [60, 80], weaponChance: 0.10, scrollChance: 0.05, scrollType: 'bronze' },
    isBoss: false,
...

  {
    ...
    enemies: ['spider', 'large_rat'], enemyCount: [1, 3], enemyBudget: [2, 3],
...

  {
    ...
    enemies: ['snake', 'viper'], enemyCount: [1, 3], enemyBudget: [2, 4],
...

  {
    ...
    pos: { row: 2, col: 2 },
    requires: ['loc_2'], requiresAny: false,
    enemies: ['bandit_club', 'bandit_bow'], enemyCount: [1, 3], enemyBudget: [3, 5],
